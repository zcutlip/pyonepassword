...
from pyonepassword.api.exceptions import OPUserListException
...
def test_user_list_group_owners_01(signed_in_op: OP, expected_user_list_data: ExpectedUserListData):
    user_list_key = "group-owners"
    ...
    result = signed_in_op.user_list(group_name_or_id="Owners")
...
def test_user_list_group_owners_02(signed_in_op: OP, expected_user_list_data: ExpectedUserListData):
    user_list_key = "group-owners"
    expected_user_list: List[ExpectedUserListEntry]
    expected_user_list = expected_user_list_data.data_for_key(user_list_key)
    expected = expected_user_list[0]
...
def test_user_list_group_owners_03(signed_in_op: OP, expected_user_list_data: ExpectedUserListData):
    user_list_key = "group-owners"
    expected_user_list: List[ExpectedUserListEntry]
    expected_user_list = expected_user_list_data.data_for_key(user_list_key)
    expected = expected_user_list[0]
...
def test_user_list_group_owners_04(signed_in_op: OP, expected_user_list_data: ExpectedUserListData):
    user_list_key = "group-owners"
    expected_user_list: List[ExpectedUserListEntry]
    expected_user_list = expected_user_list_data.data_for_key(user_list_key)
    expected = expected_user_list[0]
...
def test_user_list_group_owners_05(signed_in_op: OP, expected_user_list_data: ExpectedUserListData):
    user_list_key = "group-owners"
    expected_user_list: List[ExpectedUserListEntry]
    expected_user_list = expected_user_list_data.data_for_key(user_list_key)
    expected = expected_user_list[0]
