...
def test_item_get_ssh_key_010(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
...
def test_item_get_ssh_key_020(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
...
def test_item_get_ssh_key_030(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - category property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
...
def test_item_get_ssh_key_040(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
...
def test_item_get_ssh_key_050(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - public_key property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
...
def test_item_get_ssh_key_060(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - public_key_reference property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
...
def test_item_get_ssh_key_070(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - fingerprint property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
...
def test_item_get_ssh_key_080(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - fingerprint_reference property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
...
def test_item_get_ssh_key_090(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - private_key property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
...
def test_item_get_ssh_key_100(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - private_key_reference property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
...
def test_item_get_ssh_key_110(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - key_type property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
...
def test_item_get_ssh_key_120(valid_data: ValidData,
                              expected_ssh_key_data: ExpectedSSHKeyData):
    """
    Create:
        - OPSSHKeyItem object from "Example SSH Key"
    Verify:
        - key_type_reference property matches expected value
    """
    item_name = "Example SSH Key"
    item_dict = valid_data.data_for_name("example-ssh-key")
