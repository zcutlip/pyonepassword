...
def test_group_list_malformed_json_01(invalid_data):
    malformed_json = invalid_data.data_for_name("malformed-group-list-json")
    with pytest.raises(OPInvalidGroupListException):
        OPGroupDescriptorList(malformed_json)
